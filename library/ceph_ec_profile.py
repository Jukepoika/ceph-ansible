...
def run_module():
    ...
    if state == "present":
        rc, cmd, out, err = exec_commands(module, get_profile(module, name, cluster, container_image=container_image))
        if rc == 0:
            ...
            if current_profile['k'] != k or \
               ...
               current_profile['stripe_unit'] != stripe_unit:
            ...
            rc, cmd, out, err = exec_commands(module, create_profile(module,
                                                                     name,
                                                                     k,
                                                                     m,
                                                                     stripe_unit,
        ...
        rc, cmd, out, err = exec_commands(module, delete_profile(module, name, cluster, container_image=container_image))
        if rc == 0:
            changed = True
        else:
            rc = 0
